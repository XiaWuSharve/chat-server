...
type Message struct {
	Id         int          `gorm:"column:id;primaryKey;autoIncrement;type:int;comment:Id"`
	Uuid       string       `gorm:"column:uuid;primaryKey;uniqueIndex;type:char(100);not null;comment:消息uuid"`
